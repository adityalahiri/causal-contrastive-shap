...
class Adult():
    ...
    def initialise_causal_model(self):
        ...
        causal_model = gcm.ProbabilisticCausalModel(nx.DiGraph([('S', 'M'),('S','R'),('M','O'),('R','I'),('O','I'),('S','I')]))
        causal_model.set_causal_mechanism('S', gcm.ScipyDistribution(norm))
        ...
        causal_model.set_causal_mechanism('R', gcm.AdditiveNoiseModel(
            prediction_model=gcm.ml.create_linear_regressor(),
            noise_model=gcm.ScipyDistribution(norm)))
        causal_model.set_causal_mechanism('O', gcm.AdditiveNoiseModel(
            prediction_model=gcm.ml.create_linear_regressor(),
            noise_model=gcm.ScipyDistribution(norm)))
        causal_model.set_causal_mechanism('I', gcm.AdditiveNoiseModel(
            prediction_model=gcm.ml.create_linear_regressor(),
            noise_model=gcm.ScipyDistribution(norm)))
    ...
    def do_total_per_instance(self,x,x_s):
        ...
        if 0 in x_s:
            ...
            all_fts[0]=self.causal_model.causal_mechanism("S").draw_samples(1)[0][0]
        ...
        if 1 in x_s:
            ...
            all_fts[1]=self.causal_model.causal_mechanism("M").prediction_model._sklearn_mdl.predict([[t_0]])[0] + its_u
        ...
        if 2 in x_s:#populate all features 1 by 1
            ...
            t_0=all_fts[0]
            its_u=self.causal_model.causal_mechanism("R").noise_model.draw_samples(1)[0][0]
            all_fts[2]=self.causal_model.causal_mechanism("R").prediction_model._sklearn_mdl.predict([[t_0]])[0] + its_u
        ...
        if 3 in x_s:
            ...
            its_u=self.causal_model.causal_mechanism("O").noise_model.draw_samples(1)[0][0]
            all_fts[3]=self.causal_model.causal_mechanism("O").prediction_model._sklearn_mdl.predict([[t_0]])[0] + its_u
            
            
        y=self.model.predict_proba([[all_fts[0],all_fts[1],all_fts[2],all_fts[3]]])[0][1]
        return y
    ...
    def do_indirect(self,xt_o,xr_o,x_s,x_sp):
        ...
        for i in range(num_u):#iterate over u get expectation
            ...
            if 0 in x_s:
                ...
                xt[0]=self.causal_model.causal_mechanism("S").draw_samples(1)[0][0]
                xr[0]=self.causal_model.causal_mechanism("S").draw_samples(1)[0][0]
            ...
            if 1 in x_s:
                ...
                its_u=self.causal_model.causal_mechanism("M").noise_model.draw_samples(1)[0][0]
                xt[1]=self.causal_model.causal_mechanism("M").prediction_model._sklearn_mdl.predict([[t_0]])[0] + its_u
                ...
                if 0 in x_s:
                    ...
                    t_0=xr[0]
                its_u = self.causal_model.causal_mechanism("M").noise_model.draw_samples(1)[0][0]
                xr[1]= self.causal_model.causal_mechanism("M").prediction_model._sklearn_mdl.predict([[t_0]])[0] + its_u
            ...
            if 2 in x_s:
                ...
                if 0 in x_s:
                    ...
                    t_0=xr[0]
                its_u=self.causal_model.causal_mechanism("R").noise_model.draw_samples(1)[0][0]
                xt[2]=self.causal_model.causal_mechanism("R").prediction_model._sklearn_mdl.predict([[t_0]])[0] + its_u
                ...
                if 0 in x_s:
                    ...
                    t_0=xr[0]
                its_u = self.causal_model.causal_mechanism("R").noise_model.draw_samples(1)[0][0]
                xr[2]=self.causal_model.causal_mechanism("R").prediction_model._sklearn_mdl.predict([[t_0]])[0] + its_u
            ...
            if 3 in x_s:
                ...
                if 1 in x_s:
                    ...
                    t_0=xr[1]
                its_u=self.causal_model.causal_mechanism("O").noise_model.draw_samples(1)[0][0]
                xt[3]=self.causal_model.causal_mechanism("O").prediction_model._sklearn_mdl.predict([[t_0]])[0] + its_u
                ...
                if 1 in x_s:
                    ...
                    t_0=xr[1]
                its_u = self.causal_model.causal_mechanism("O").noise_model.draw_samples(1)[0][0]
                xr[3]=self.causal_model.causal_mechanism("O").prediction_model._sklearn_mdl.predict([[t_0]])[0] + its_u
            ...
            yt=self.model.predict_proba([[xt[0],xt[1],xt[2],xt[3]]])[0][1]
            yr=self.model.predict_proba([[xr[0],xr[1],xr[2],xr[3]]])[0][1]
            y = y + (yt-yr)
        return y/num_u

    def do_direct(self,xt_o,xr_o,x_s,x_sp):
        #ft_map={0:"S",1:"M",2:"R",3:"O"}
        xt=copy.deepcopy(xt_o)
        xr=copy.deepcopy(xr_o)
        num_u=100
        y=0
